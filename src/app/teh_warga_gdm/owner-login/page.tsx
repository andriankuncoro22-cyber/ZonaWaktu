      ...
      <div className="relative z-10 flex flex-col items-center w-full max-w-sm px-4">
        <div className="flex items-center gap-3 mb-8">
          <div className="h-11 w-11 rounded-2xl bg-emerald-500/20 flex items-center justify-center border border-emerald-400/30 backdrop-blur-md shadow-inner">
            <CupSoda className="h-6 w-6 text-lime-300" />
          </div>
        ...
        <div className="w-full p-8 bg-black/30 border border-emerald-400/30 backdrop-blur-xl rounded-3xl shadow-2xl">
          <div className="flex items-center justify-center gap-2 mb-6">
            ...
            <h2 className="text-xl font-black uppercase tracking-widest text-center">Owner Login</h2>
          </div>
          ...
          <div className="space-y-4">
            ...
            <Button onClick={handleLogin} className="w-full bg-gradient-to-r from-emerald-400 to-lime-300 text-[#022c22] hover:from-emerald-300 hover:to-lime-200 font-black uppercase tracking-widest rounded-xl h-11 shadow-lg shadow-emerald-950/40 border-none mt-2">
              Masuk Dashboard
            </Button>
          </div>
        </div>
